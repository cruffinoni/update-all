...
Tracks whether the tool has already run within the last 12 hours using a sentinel file.
"""
...
def already_ran_today() -> bool:
    """Return True if the sentinel file records a run within the last 12 hours."""
    stored = last_ran_at()
